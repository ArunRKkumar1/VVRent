  ...
  return (
    <div className='container  mt-4 m-auto p-3 pt-4 w-full md:w-2/3 '>
      ...
      <form className='w-full radius1 p-4 mt-4 text-white  bg-[#3B4179] dark:bg-[#222222]' action="">
        ...
        <Input className='input1' label='Aadhaar' />
        ...
        <div className='mt-8 flex flex-col     gap-4'>
         <div className="">
                        <Input type='file' className='input1' inputClass='text-white' label='Upload Aadhaar'/>
                        <Input type='file' className='input1' inputClass='text-white' label='Upload License'/>
         </div>
